...
export default function Notifications() {
  ...
  if (loading) return <Shell persona={persona} displayName={displayName} title="Notifications"><div className="flex items-center justify-center h-64"><div className="w-8 h-8 rounded-full border-2 border-surface-border border-t-violet-500 animate-spin" /></div></Shell>;
