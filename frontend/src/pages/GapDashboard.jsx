...
function GapRow({ gap, startupId }) {
  return (
    <Link to={`/app/gaps/${gap.id}?startup=${startupId}`} className="flex items-center justify-between py-4 px-1 border-b border-surface-border last:border-0 hover-lift hover:bg-surface-muted/50 -mx-1 rounded-lg transition-colors">
